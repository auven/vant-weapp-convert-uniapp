<template>
  <div>
    ...
    <demo-block title="按钮尺寸" padding>
      <van-button type="primary" size="large" block custom-class="demo-margin-bottom" class="demo-margin-bottom">大号按钮</van-button>
      <van-button type="primary" custom-class="demo-margin-right" class="demo-margin-right">普通按钮</van-button>
      <van-button type="primary" size="small" custom-class="demo-margin-right" class="demo-margin-right">小型按钮</van-button>
      <van-button type="primary" size="mini">迷你按钮</van-button>
    </demo-block>

    <demo-block title="块级元素" padding>
      <van-button type="primary" custom-class="demo-margin-bottom" class="demo-margin-bottom">普通按钮</van-button>
      <van-button type="primary" block>块级元素</van-button>
    </demo-block>

    <demo-block title="自定义颜色" padding>
      <van-button color="#7232dd" custom-class="demo-margin-right" class="demo-margin-right">单色按钮</van-button>
      <van-button color="#7232dd" custom-class="demo-margin-right" class="demo-margin-right" plain>单色按钮</van-button>
